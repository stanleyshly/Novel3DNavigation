...
if __name__ == '__main__':
    ...
    parser.add_argument('--lr', type=float, default=1e-4) # 1e-4 works well for batch size 4 and more
    ...
    parser.add_argument('--batch_size', type=int, default=6) # 16, Resnet uses less memory, can do 4 batchs(and more)
